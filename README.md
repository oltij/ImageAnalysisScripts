[README_GENERAL_IMAGE_ANALYSIS_PIPELINE.md](https://github.com/user-attachments/files/32267507/README_GENERAL_IMAGE_ANALYSIS_PIPELINE.md)
...
The software setup only needs to be performed once for a working environment/container.
...
The environment contains the Python packages used by the image-processing scripts, including packages such as:
...
Run the appropriate CellProfiler pipeline independently for each channel.
